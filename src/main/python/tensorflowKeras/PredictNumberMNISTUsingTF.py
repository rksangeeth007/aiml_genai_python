...
num_classes = 10 # total classes (0-9 digits).   //Total classification possibilities
num_features = 784 # data features (img shape: 28*28).   //28 pixels in X -axis and 28 pixels on Y-axis
...
# Network parameters.
n_hidden = 512 # Number of neurons.    //This tell no: of Neurons within the hidden layer
